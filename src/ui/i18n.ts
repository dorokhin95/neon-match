...
const RU: Dict = {
  ...
  'super.adText': 'После короткой рекламы вы получите «{name}». Сейчас это заглушка — реклама не показывается.',
  'super.adWatch': 'Смотреть (заглушка)',
...
const EN: Dict = {
  ...
  'super.adText': 'After a short ad you will get “{name}”. This is a stub — no ad is shown yet.',
  'super.adWatch': 'Watch (stub)',
